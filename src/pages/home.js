                ...
                <div className="container-blog">
                    ...
                    <div className="row ">
                        <div className="col-12 col-md-7" style={{ cursor: "pointer"}}>
                            <img className="lazy" src="/images/blog.jpeg" data-src="/image/blogs/rare-early-medieval-ivory-carving0-acquired-for-£2m-by-v&amp;a/96a404f3-45b2-4293-924a-2f4d4fbb1438.jpeg" onerror="this.src='/img/no_image-100x100.png'" style={{width:"70%"}} />
                        ...
                        <div className="col-12 col-md-5">
                            <div  style={{ cursor: "pointer" }}>
                                <img style={{ height: "250px" }} className="lazy" src="/images/blogRome.jpeg" data-src="/image/blogs/a-magnificent-ancient-rome-sculpture-exhibition-at-the-musee-du-louvre-june-26-to-november-11-2024/11e0e6ac-0cc8-4686-bed3-c120e2be20d2-_1_к.jpeg" onerror="this.src='/img/no_image-100x100.png'"/>
                                <div className="d-flex flex-column">
                            ...
                            <div style={{ cursor: "pointer" }}>
                                <img style={{ height: "250px" }} className="lazy" src="/images/blogGogh.jpg" data-src="/image/blogs/new-acquisition-in-the-van-gogh-museum-clovis-sleeping-by-paul-gauguin/7e906b17-bf83-4ea7-8067-f46caa7ec38d.jpg" onerror="this.src='/img/no_image-100x100.png'" />
                                <div className="d-flex flex-column">
                ...
                <div className="container-articles">
                    ...
                    <div className="row ">
                        <div className="col-12 col-md-4"  style={{ cursor: "pointer" }}>
                            <img className="lazy" src="/images/articles.jpeg" data-src="/image/articles/the-exquisite-art-of-japanese-cloisonné-enamel/4d92a03f-fb58-4a9e-b983-98547365d5b8.jpeg" onerror="this.src='/img/no_image-100x100.png'" style={{width:"280px"}}/>
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="blog-read-more my-3">
                                        <a href="/articleart">Read more&nbsp;&nbsp;<FaLongArrowAltRight/></a>
                                    </div>
                                </div>
                        </div>
                        <div className="col-12 col-md-4" style={{ cursor: "pointer" }}>
                            <img className="lazy" src="/images/Новый проект .jpg" data-src="/image/articles/exploring-the-rich-heritage-of-japanese-and-chinese-cloisonne-enamel/Новый проект - 2024-05-19T002530.282.jpg" onerror="this.src='/img/no_image-100x100.png'" style={{width:"200px"}}/>
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="blog-read-more my-3">
                                        <a href="/articlerich">Read more&nbsp;&nbsp;<FaLongArrowAltRight/></a>
                                    </div>
                                </div>
                        </div>
                        <div className="col-12 col-md-4" onclick=""  style={{ cursor: "pointer" }}>
                            <img className="lazy" src="/images/Новый .jpg" data-src="/image/articles/the-evolution-of-cartier-a-tale-of-elegance-innovation-and-prestige/Новый проект - 2024-05-13T160635.158.jpg" onerror="this.src='/img/no_image-100x100.png'" style={{width:"215px"}}/>
                                <div className="d-flex flex-column">
                                    ...
                                    <div className="blog-read-more my-3">
                                        <a href="/articlecartier">Read more&nbsp;&nbsp;<FaLongArrowAltRight/></a>
                                    </div>
                                </div>
                        </div>
                    </div>
