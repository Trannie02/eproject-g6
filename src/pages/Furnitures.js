            ...
            <div className="picture">
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur1`)} >
                    <div className="card-body">
                        <img src="/Furniture/ottoman-1a.jpeg" className="card-img-top" />
                        <hr />
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur2`)} >
                    <div className="card-body">
                        <img src="/Furniture/ottoman-2a.jpeg" className="card-img-top" />
                        <hr />
                        <p className="card-text">Detail
                            Model: 2453228
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur3`)} >
                    <div className="card-body">
                        <img src="/Furniture/ottoman-3a.jpeg" className="card-img-top" />
                        <hr />
                        <p className="card-text">Detail
                            Model: 3310022
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur4`)} >
                    <div className="card-body">
                        <img src="/Furniture/sofa-1a.jpeg" className="card-img-top" />
                        <hr />
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur5`)} >
                    <div className="card-body">
                        <img src="/Furniture/sofa-2a.jpeg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                            Detail :
                            Model: 9719506
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur6`)} >
                    <div className="card-body">
                        <img src="/Furniture/sofa-3a.jpeg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                            Detail
                            Model: 6980020
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur7`)} >
                    <div className="card-body">
                        <img src="/Furniture/table -1a.jpg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur8`)} >
                    <div className="card-body">
                        <img src="/Furniture/table -2a.jpg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                            SPECIFICATIONS:
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur9`)} >
                    <div className="card-body">
                        <img src="/Furniture/table -3a.jpeg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                            <p> Detail:</p>
                            Model: 3864410
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur10`)} >
                    <div className="card-body">
                        <img src="/Furniture/dining chair 1.jpg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                            Seat: Polyester
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur11`)} >
                    <div className="card-body">
                        <img src="/Furniture/dining chair 4.jpg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
                            Size: 54cm (W) x 55cm (D) x 82cm (H)
                            Seat Height: 45cm
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fur11`)} >
                    <div className="card-body">
                        <img src="/Furniture/dining chair 7.jpg" className="card-img-top" />
                        <hr />
                        <p className="card-text">
