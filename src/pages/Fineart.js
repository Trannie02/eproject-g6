            ...
            <div className="picture" >
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fine1`)} >
                    <div className="card-body">
                        <img src="/Fineart/fineart1.jpg" className="card-img-top" />
                        <hr />
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fine2`)}>
                    <div className="card-body">
                        <img src="/Fineart/fineart2.jpg" className="card-img-top" />
                        <hr />
                ...
                <div className="card" style={{ width: "18rem" }} onClick={(ev) => navigate(`/fine3`)}>
                    <div className="card-body">
                        <img src="/Fineart/fineart3.jpg" className="card-img-top" />
                        <hr />
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart4.jpg" className="card-img-top"/>
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart5.jpg" className="card-img-top" />
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart6.jpg" className="card-img-top"  />
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart7.jpg" className="card-img-top" />
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart8.jpg" className="card-img-top"  />
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart9.jpg"className="card-img-top" />
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart10.jpg"className="card-img-top" />
                    <hr/>
                ...
                <div className="card-body">
                    <img src="/Fineart/fineart11.jpg"className="card-img-top" />
                    <hr/>
