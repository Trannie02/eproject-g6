...
export default function ArticleCartier() {
    return (
        <div className="article-item">
            <div class="row my-5 article-content-center">
                <img src="/images/Новый .jpg" />
            </div>

            <div class="row article-content-center">
                <h2>The Evolution of Cartier: A Tale of Elegance, Innovation, and Prestige</h2>
            </div>

            <div class="my-5 row article-content">
                ...
                <p><img alt="" src="/images/Новый .jpg" style={{ height: "540px", width: "720px" }} /></p>
            ...
            <div class="my-4 row">
                <div class="col-12 d-flex justify-content-center">
                    <a class="btn btn-antique-default" href="/articleshome"><FaLongArrowAltLeft/>&nbsp;&nbsp;Return</a>
                </div>
            </div>
